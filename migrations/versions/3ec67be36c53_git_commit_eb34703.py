...
Revision ID: 3ec67be36c53
Revises: 
Create Date: 2024-04-11 16:22:42.492681
...
def upgrade() -> None:
    ...
    sa.Column('em_model_version', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('created_datetime', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_datetime', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['document_id'], ['document.id'], ),
    ...
    op.create_table('author_repository_contributor_link',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('document_id', sa.Integer(), nullable=False),
    sa.Column('repository_contributor_id', sa.Integer(), nullable=False),
    sa.Column('em_model_version', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('created_datetime', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_datetime', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['document_id'], ['document.id'], ),
    sa.ForeignKeyConstraint(['repository_contributor_id'], ['repository_contributor.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('document_id', 'repository_contributor_id')
    )
...
def downgrade() -> None:
    ...
    op.drop_table('author_repository_contributor_link')
