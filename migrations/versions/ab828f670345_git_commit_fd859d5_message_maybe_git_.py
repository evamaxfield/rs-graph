...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "source_code_embedding_uri",
            sqlmodel.sql.sqltypes.AutoString(),
            nullable=True,
        ),
        sa.Column(
            "source_code_embedding_model_name",
            sqlmodel.sql.sqltypes.AutoString(),
            nullable=True,
        ),
        sa.Column(
            "source_code_embedding_model_version",
            sqlmodel.sql.sqltypes.AutoString(),
            nullable=True,
        ),
        sa.Column(
            "source_code_embedding_updated_datetime", sa.DateTime(), nullable=True
        ),
        sa.Column("ecosystems_uuid", sqlmodel.sql.sqltypes.AutoString(), nullable=True),
        sa.Column(
            "created_datetime",
    ...
    op.create_table(
        ...
        sa.Column(
            "committer_username", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column(
            "committer_email", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        ...
        sa.Column(
            "filenames_changed", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column(
            "created_datetime",
            sa.DateTime(),
    ...
    op.create_table(
        ...
        sa.Column(
            "developer_researcher_match_model_name",
            sqlmodel.sql.sqltypes.AutoString(),
            nullable=True,
        ),
        sa.Column(
            "developer_researcher_match_model_version",
            sqlmodel.sql.sqltypes.AutoString(),
            nullable=True,
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "document_funding_match_model_name",
            sqlmodel.sql.sqltypes.AutoString(),
            nullable=True,
        ),
        sa.Column(
            "document_funding_match_model_version",
            sqlmodel.sql.sqltypes.AutoString(),
            nullable=True,
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column("source_id", sa.Integer(), nullable=False),
        sa.Column(
            "repository_document_match_model_name",
            sqlmodel.sql.sqltypes.AutoString(),
            nullable=True,
        ),
        sa.Column(
            "repository_document_match_model_version",
            sqlmodel.sql.sqltypes.AutoString(),
            nullable=True,
        ),
        sa.Column(
    ...
    op.create_table(
        "repository_funding_instance",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("repository_id", sa.Integer(), nullable=False),
        sa.Column("funding_instance_id", sa.Integer(), nullable=False),
        sa.Column("source_id", sa.Integer(), nullable=False),
        sa.Column(
            "repository_funding_match_model_name",
            sqlmodel.sql.sqltypes.AutoString(),
            nullable=True,
        ),
        sa.Column(
            "repository_funding_match_model_version",
            sqlmodel.sql.sqltypes.AutoString(),
            nullable=True,
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "acknowledgement_extraction_model_name",
            sqlmodel.sql.sqltypes.AutoString(),
            nullable=True,
        ),
        sa.Column(
            "acknowledgement_extraction_model_version",
            sqlmodel.sql.sqltypes.AutoString(),
            nullable=True,
        ),
        sa.Column(
    ...
    op.create_table(
        "researcher_document_credit_role",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("researcher_id", sa.Integer(), nullable=False),
        sa.Column("document_id", sa.Integer(), nullable=False),
