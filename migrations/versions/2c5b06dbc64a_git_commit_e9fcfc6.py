...
Revision ID: 2c5b06dbc64a
Revises: 
Create Date: 2026-01-29 12:12:27.529400
...
def upgrade() -> None:
    ...
    sa.Column('created_datetime', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_datetime', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['code_host_id'], ['code_host.id'], name=op.f('fk_developer_account_code_host_id_code_host'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_developer_account')),
    sa.UniqueConstraint('code_host_id', 'username', name=op.f('uq_developer_account_code_host_id'))
    )
    ...
    sa.Column('created_datetime', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_datetime', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['funder_id'], ['funder.id'], name=op.f('fk_funding_instance_funder_id_funder'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_funding_instance')),
    sa.UniqueConstraint('funder_id', 'award_id', name=op.f('uq_funding_instance_funder_id'))
    )
    ...
    sa.Column('created_datetime', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_datetime', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['source_id'], ['source.id'], name=op.f('fk_location_source_id_source'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_location')),
    sa.UniqueConstraint('landing_page_url', 'pdf_url', 'source_id', name=op.f('uq_location_landing_page_url'))
    )
    ...
    sa.Column('created_datetime', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_datetime', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['code_host_id'], ['code_host.id'], name=op.f('fk_repository_code_host_id_code_host'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_repository')),
    sa.UniqueConstraint('code_host_id', 'owner', 'name', name=op.f('uq_repository_code_host_id'))
    )
    with op.batch_alter_table('repository', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_repository_processed_at_sha'), ['processed_at_sha'], unique=False)
    ...
    sa.Column('created_datetime', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_datetime', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['best_open_access_location_id'], ['location.id'], name=op.f('fk_document_best_open_access_location_id_location'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['primary_location_id'], ['location.id'], name=op.f('fk_document_primary_location_id_location'), ondelete='CASCADE'),
    ...
    sa.Column('created_datetime', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_datetime', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['developer_account_id'], ['developer_account.id'], name=op.f('fk_repository_contributor_developer_account_id_developer_account'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['repository_id'], ['repository.id'], name=op.f('fk_repository_contributor_repository_id_repository'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_repository_contributor')),
    sa.UniqueConstraint('repository_id', 'developer_account_id', name=op.f('uq_repository_contributor_repository_id'))
    )
    ...
    sa.Column('created_datetime', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_datetime', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['repository_id'], ['repository.id'], name=op.f('fk_repository_file_repository_id_repository'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_repository_file')),
    sa.UniqueConstraint('repository_id', 'path', name=op.f('uq_repository_file_repository_id'))
    )
    ...
    sa.Column('created_datetime', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_datetime', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['repository_id'], ['repository.id'], name=op.f('fk_repository_language_repository_id_repository'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_repository_language')),
    sa.UniqueConstraint('repository_id', 'language', name=op.f('uq_repository_language_repository_id'))
    )
    ...
    sa.Column('created_datetime', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_datetime', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['repository_id'], ['repository.id'], name=op.f('fk_repository_readme_repository_id_repository'), ondelete='CASCADE'),
    ...
    sa.Column('created_datetime', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_datetime', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['developer_account_id'], ['developer_account.id'], name=op.f('fk_researcher_developer_account_link_developer_account_id_developer_account'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['researcher_id'], ['researcher.id'], name=op.f('fk_researcher_developer_account_link_researcher_id_researcher'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_researcher_developer_account_link')),
    sa.UniqueConstraint('researcher_id', 'developer_account_id', name=op.f('uq_researcher_developer_account_link_researcher_id'))
    )
    with op.batch_alter_table('researcher_developer_account_link', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_researcher_developer_account_link_last_snowball_processed_datetime'), ['last_snowball_processed_datetime'], unique=False)
    ...
    sa.Column('created_datetime', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_datetime', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['document_id'], ['document.id'], name=op.f('fk_document_abstract_document_id_document'), ondelete='CASCADE'),
    ...
    sa.Column('created_datetime', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_datetime', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['document_id'], ['document.id'], name=op.f('fk_document_alternate_doi_document_id_document'), ondelete='CASCADE'),
    ...
    sa.Column('created_datetime', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_datetime', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['document_id'], ['document.id'], name=op.f('fk_document_contributor_document_id_document'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['researcher_id'], ['researcher.id'], name=op.f('fk_document_contributor_researcher_id_researcher'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_document_contributor')),
    sa.UniqueConstraint('researcher_id', 'document_id', name=op.f('uq_document_contributor_researcher_id'))
    )
    ...
    sa.Column('created_datetime', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_datetime', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['document_id'], ['document.id'], name=op.f('fk_document_funding_instance_document_id_document'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['funding_instance_id'], ['funding_instance.id'], name=op.f('fk_document_funding_instance_funding_instance_id_funding_instance'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_document_funding_instance')),
    sa.UniqueConstraint('document_id', 'funding_instance_id', name=op.f('uq_document_funding_instance_document_id'))
    )
    ...
    sa.Column('created_datetime', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_datetime', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['dataset_source_id'], ['dataset_source.id'], name=op.f('fk_document_repository_link_dataset_source_id_dataset_source'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['document_id'], ['document.id'], name=op.f('fk_document_repository_link_document_id_document'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['repository_id'], ['repository.id'], name=op.f('fk_document_repository_link_repository_id_repository'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_document_repository_link')),
    sa.UniqueConstraint('document_id', 'repository_id', name=op.f('uq_document_repository_link_document_id'))
    )
    with op.batch_alter_table('document_repository_link', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_document_repository_link_iteration'), ['iteration'], unique=False)
    ...
    sa.Column('created_datetime', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_datetime', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['document_id'], ['document.id'], name=op.f('fk_document_topic_document_id_document'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['topic_id'], ['topic.id'], name=op.f('fk_document_topic_topic_id_topic'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_document_topic')),
    sa.UniqueConstraint('document_id', 'topic_id', name=op.f('uq_document_topic_document_id'))
    )
    ...
    sa.Column('created_datetime', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_datetime', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['document_contributor_id'], ['document_contributor.id'], name=op.f('fk_document_contributor_institution_document_contributor_id_document_contributor'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['institution_id'], ['institution.id'], name=op.f('fk_document_contributor_institution_institution_id_institution'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_document_contributor_institution')),
    sa.UniqueConstraint('document_contributor_id', 'institution_id', name=op.f('uq_document_contributor_institution_document_contributor_id'))
    )
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('document_repository_link', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_document_repository_link_iteration'))
    ...
    with op.batch_alter_table('researcher_developer_account_link', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_researcher_developer_account_link_last_snowball_processed_datetime'))
