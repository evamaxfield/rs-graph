...
- The relationship between scientific software development and academic credit systems represents a complex intersection of traditional academic practices and modern research requirements.
    ...
    - increased emphasis on large scale (big data) projects has resulted in larger need for software development to manage computation and data
...
- (H1) Modern research increasingly depends on collaborative software development, yet we lack systematic evidence of how code contribution patterns affect research outcomes.
    ...
    - in our case, we believe that more code contributors may signal a more technical research project and that technical complexity may be rewarded with more citations, as such, more code contributors should be associated with more article citations

- (H2) The evolution of research projects from fixed-duration studies to ongoing software-driven endeavors challenges traditional models of academic credit attribution.
    - research projects traditionally viewed as fixed-duration endeavors (which we know isn't always the case)
    - using this viewpoint, we seek to understand the relationship between the authorship status of all code contributors and project duration
    - we believe that longer projects will have more author code contributors than non-author code contributors as long term software commitments are more likely to be recognized as substantial contributions and therefore warrant authorship
...
- (H3 and H4) Academic authorship conventions signal both intellectual contribution and project responsibilities, yet their relationship to software development remains poorly understood.
    ...
    - we believe that first authors and corresponding authors will have higher proportions of code contribution than not. Other author positions and non-corresponding authors will have lower proportions of code contribution than not.
...
- (H5) Academic career advancement has historically depended on traditional impact metrics, creating potential tension for researchers who dedicate significant time to software development.
    - existing metrics primarily capture publication and citation counts
...
- Understanding these relationships is crucial for developing equitable academic credit systems that recognize the full spectrum of research contributions.
    ...
    - importance of large-scale quantitative evidence for understanding the current state of academic credit systems
    - implications for academic hiring and promotion decisions
    - potential to develop new impact metrics that capture software (and other) contributions
