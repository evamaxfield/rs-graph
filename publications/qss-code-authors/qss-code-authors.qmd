...
# LaTeX templates
stats_piece_initial_row_template = """    \\multirow{{{n_rows}}}{{*}}{{{row_name}}} & {value_name} & {article_repo_pairs} & {authors} & {devs} \\\\"""
...
\\label{tab:tbl-rs-graph-overall-counts}
...
for stats_portion, stats_name, value_key in [
    ...
    if stats_name != "Total":  # Don't add midrule after the Total row
        section_latex += "\n    \\midrule"
