...
- Modern scientific research increasingly requires the public sharing of research code, creating unique opportunities to study the relationship between academic authorship and software development.
    - many journals and platforms now require or recommend code sharing
    ...
    - need to mention scale/scope of data collection here
...
- Our data collection process leverages multiple complementary sources of linked scientific articles and code repositories to ensure comprehensive coverage.
    ...
    - need to add details about timeline, number of papers/repos collected
...
- Through integration of multiple data sources, we extract detailed information about both the academic and software development aspects of each project.
    - OpenAlex API provides publication metadata and citation metrics
    - GitHub API provides repository metadata and repository contributor information
    - need to add details about what specific metrics you collect
    - need to discuss any data cleaning or filtering steps
...
- We developed an annotation process to create a robust training dataset while maximizing efficiency and accuracy.
    ...
    - two independent annotators reviewing 3000 pairs
...
- The resulting annotated dataset provides a comprehensive foundation for training our predictive model while highlighting common patterns in author-developer identity matching.
    - distribution of positive/negative matches
    - analysis of available identity information
    - need table showing feature availability statistics
...
- We employed a systematic evaluation to identify optimal combination of base models and input features.
    ...
    - explanation of data splitting approach
    - need specifics on evaluation metrics

- After extensive model comparison we find that [Base Model X] with [Feature Set Y] achieves the best performance for author-developer matching.
    - performance metrics
    - analysis of feature importance
    - need comprehensive results table

- To promote reproducibility and enable future research, we have made our trained model and associated tools publicly available.
