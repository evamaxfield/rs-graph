...
Next, we build upon these general findings to movtivate three specific hypothesis about code contributions and credit that we then test using the `rs-graph-v1` dateset.
