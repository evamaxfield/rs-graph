...
```{python}
# LaTeX templates
stats_piece_initial_row_template = """    \\multirow{{{n_rows}}}{{*}}{{\\textbf{{{row_name}}}}} & {value_name} & {article_repo_pairs} & {authors} & {devs} \\\\"""
...
for stats_portion, stats_name, value_key in [
    ...
    if stats_name == "Total":
        ...
        # Add the first row with the category label
        ...
        # Add subsequent rows
        for stats_piece in stats_portion[1:]:
            stats_portion_latex.append(
                stats_piece_subsequent_row_template.format(
                    value_name=stats_piece[value_key],
                    article_repo_pairs=stats_piece["n_article_repo_pairs"],
