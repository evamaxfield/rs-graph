...
- TODO: add more interpretation / text here
- In short, we see that regardless of domain, article type, and open access status, first authors tend to be code-contributors, while middle and last authors tend not to be code-contributors.
- See @tbl-post-hoc-tests-on-author-positions for a detailed breakdown of the author positions of code-contributing authors.
...
- TODO: add more interpretation / text here
- See @tbl-post-hoc-tests-on-corresponding-status for a detailed breakdown of the corresponding status of code-contributing authors.
...
pd.concat([
    domain_code_corresponding,
    article_type_code_corresponding,
    open_access_status_code_corresponding,
    overall_code_corresponding,
])
```