...
Our data collection process leverages multiple sources of linked scientific articles and code repositories to ensure broad coverage of multiple domains and article types. Our dataset combines article-source-code-repository pairs from:
...
To reduce the complexity of dataset processing and enrichment, we filter out any article-source-code-repository pairs that store code somewhere other than GitHub. While this decision prioritizes processing simplicity, we acknowledge that while GitHub is the predominate host of scientific software [@Cao2023TheRO; @escamilla2022riseofgithub], it is also stored and shared on other platforms, which should be investigated as part of future research [@trujillo2022penumbra].
