...
repositories = repositories[repositories["id"].isin(repositories_with_code)]
doc_repo_links = doc_repo_links[doc_repo_links["repository_id"].isin(repositories_with_code)]
