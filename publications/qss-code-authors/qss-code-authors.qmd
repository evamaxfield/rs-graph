...
non_author_to_author_dev_pearson_results
```

- Next we investigate the relationship between the duration of a project and the coding contributorship of the research team.
  - We find 
...
- Building upon previous work examining standardized contribution frameworks and authorship attribution practices (see @sec-background), we investigate how project duration may influence the distribution of coding roles between authors and non-authors.
 - We hypothesize that projects with longer development durations may show higher proportions of code-contributing authors compared to code-contributing non-authors, as sustained technical engagement could increase the likelihood of receiving authorship recognition.

- Our analysis confirms our findings and we find a small but statistically significant positive correlation (r = 0.07, p < 0.001) between a repository's commit duration and its ratio of code-contributing non-authors to code-contributing authors.
 - This suggests that, contrary to our hypothesis, longer-running projects actually tend to have slightly higher proportions of non-author developers relative to author developers.
 - However, while this relationship is statistically significant, the correlation coefficient indicates that this effect is relatively modest in magnitude.
