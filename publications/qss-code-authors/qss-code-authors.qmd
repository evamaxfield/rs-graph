...
sns.relplot(
    data=team_comp_no_push_after_pub_long.rename(columns={"publication_year": "Publication Year"}),
    x="Publication Year",
    y="count",
    hue="Contributor Type",
    hue_order=[
...
#| fig-cap: "Mean number of Non-Code-Contributing Authors, Code-Contributing Authors, and Code-Contributing Non-Authors by Total Authors. Only includes article-repository pairs with a most recent commit no later than 90 days after publication and excludes research-teams which are in the top 3% of total author sizes."
