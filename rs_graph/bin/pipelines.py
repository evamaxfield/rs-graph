...
def process(
    ...
    split_and_store_results_partial(results=get_dataset_results)
    ...
    split_and_store_results_partial(results=code_filtering_results)
    ...
    split_and_store_results_partial(results=open_alex_processing_results)
